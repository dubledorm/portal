...
shared_examples 'create_user_and_service should create user' do
  it 'should create user' do
    expect{ get controller_action, params: { user: user_param_hash } }.to change(User, :count).by(1)
  end
end
...
shared_examples 'create_user_and_service should create service' do
  it 'should create service' do
    expect{ get controller_action, params: { user: user_param_hash } }.to change(Service, :count).by(1)
  end
end
...
shared_examples 'create_user_and_service should not create user' do
  it 'should not create user' do
    expect{ get controller_action, params: { user: user_param_hash } }.to change(User, :count).by(0)
  end
end
